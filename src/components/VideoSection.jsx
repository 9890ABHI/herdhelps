...
const VideoSection = () => {
  return (
    <div className='flex flex-col justify-center items-center py-28  w-full bg-[#0D0C0C] text-white'>
        <div className="text-lg font-bold text-[#39B54A]">SEE HOW OUR APP WORKS </div>
        <div className="text-4xl font-semibold text-center">We love what we do, check out <br /> some of our Tutorials</div>
        <div className='flex gap-20 px-5 pt-16'>
